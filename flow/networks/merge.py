...
class MergeNetwork(Network):
    ...
    * **speed_limit** : max speed limit of the network
    ...
    def specify_routes(self, net_params):
        """See parent class."""
        rts = {
            "inflow_highway": ["inflow_highway", "left", "center", "vsl"],
            "left": ["left", "center", "vsl"],
            "center": ["center", "vsl"],
            "inflow_merge": ["inflow_merge", "bottom", "center", "vsl"],
            "bottom": ["bottom", "center", "vsl"]
        }

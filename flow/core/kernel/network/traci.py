...
class TraCIKernelNetwork(BaseKernelNetwork):
    ...
    def generate_network(self, network):
        ...
        此类使用特定于网络的特性来生成初始化sumo实例所需的xml文件。这包括用于网络几何体的.net.xml文件
...
# 2023.03.09.17.25
    ...
    def get_laststep_vehicleids(self, edge_id):
        return self.kernel_api.edge.getLastStepVehicleIDs(edge_id)
# 添加的部分traci控制指令函数
